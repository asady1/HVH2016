...
python generalTreeAnalyzer_80X.py --pathIn=root://cmsxrootd.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/ZprimeToZhToZhadhbb_narrow_M-2500_13TeV-madgraph/VHBB_HEPPY_V23_ZprimeToZhToZhadhbb_narrow_M-2500_13TeV-madgraph__spr16MAv2-puspr16_HLT_80r2as_v14-v1/160717_165241/0000/ --outName=Zp_2500_V23_V2 --trigger=False --jets=True --deta=True --isMC=True --xsec=1. --min=0 --max=2 --file=two.txt

xrdcp Zp_2500_V23_V2_0.root root://cmseos.fnal.gov//store/user/asady1
