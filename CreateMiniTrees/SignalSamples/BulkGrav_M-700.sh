...
cp ../../BulkGrav_M-700.txt .
cp ../../trigger_objects.root .

python generalTreeAnalyzer_80X.py --pathIn=root://cmsxrootd.fnal.gov//store/user/lpchbb/HeppyNtuples/V23/GluGluToBulkGravitonToHHTo4B_M-700_narrow_13TeV-madgraph/VHBB_HEPPY_V23_GluGluToBulkGravitonToHHTo4B_M-700_narrow_13TeV-madgraph__spr16MAv2-puspr16_HLT_80r2as_v14-v1/160717_000111/0000/ --outName=BulkGrav_M-700 --trigger=False --jets=True --deta=True --isMC=True --xsec=1 --is2p1=False --saveTrig=True --min=0 --max=3 --file=BulkGrav_M-700.txt

xrdcp BulkGrav_M-700_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHHHTo4b/V23/
ZJets/
