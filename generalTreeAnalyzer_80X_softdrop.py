...
myTree.Branch('jet1_puppi_pt', jet1_puppi_pt, 'jet1_puppi_pt/F')
myTree.Branch('jet2_puppi_pt', jet2_puppi_pt, 'jet2_puppi_pt/F')
myTree.Branch('jet1_puppi_eta', jet1_puppi_eta, 'jet1_puppi_eta/F')
myTree.Branch('jet2_puppi_eta', jet2_puppi_eta, 'jet2_puppi_eta/F')
myTree.Branch('jet1_puppi_phi', jet1_puppi_phi, 'jet1_puppi_phi/F')
myTree.Branch('jet2_puppi_phi', jet2_puppi_phi, 'jet2_puppi_phi/F')
myTree.Branch('jet1_puppi_mass', jet1_puppi_mass, 'jet1_puppi_mass/F')
myTree.Branch('jet2_puppi_mass', jet2_puppi_mass, 'jet2_puppi_mass/F')
myTree.Branch('jet1_puppi_tau21', jet1_puppi_tau21, 'jet1_puppi_tau21/F')
myTree.Branch('jet2_puppi_tau21', jet2_puppi_tau21, 'jet2_puppi_tau21/F')
myTree.Branch('jet1_puppi_msoftdrop', jet1_puppi_msoftdrop, 'jet1_puppi_msoftdrop/F')
myTree.Branch('jet2_puppi_msoftdrop', jet2_puppi_msoftdrop, 'jet2_puppi_msoftdrop/F')
myTree.Branch('jet1_puppi_msoftdrop_corrL2L3', jet1_puppi_msoftdrop_corrL2L3, 'jet1_puppi_msoftdrop_corrL2L3/F')
...
#				nLooseElectrons += 1
	...
	jet_puppi_msoftdrop_raw=[]
	    ...
	    if jettemp.Pt() > 200. and abs(jettemp.Eta()) < 2.4: 	
		    ...
		    jet_puppi_pt.append(treeMine.FatjetAK08ungroomed_puppi_pt[j])
...
#		CA15jet2 = MatchCollection2(CA15prunedJets, jets[idxH2],CA15jet1)
	...
	jet1_puppi_pt[0] = jet_puppi_pt[idxH1]
	jet1_puppi_eta[0] = jet_puppi_eta[idxH1]
        jet1_puppi_phi[0] = jet_puppi_phi[idxH1]
        jet1_puppi_mass[0] = jet_puppi_mass[idxH1]
...
#	        jet1pmass_CA15[0] = FatjetCA15pruned_mass[CA15jet1]
	...
	jet1_pruned.SetPtEtaPhiM(jet1pt[0],jet1eta[0],jet1phi[0],jet1pmass[0])
        ...
        if len(jets) > 1:
            ...
            jet2_puppi_pt[0] = jet_puppi_pt[idxH2]
            jet2_puppi_eta[0] = jet_puppi_eta[idxH2]
            jet2_puppi_phi[0] = jet_puppi_phi[idxH2]
            jet2_puppi_mass[0] = jet_puppi_mass[idxH2]
            jet2_puppi_tau21[0] = jet_puppi_tau21[idxH2]
