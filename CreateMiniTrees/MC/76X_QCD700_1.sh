...
python getMiniTrees.py --pathIn=root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V24b/QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/VHBB_HEPPY_V24a_QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-Py8__spr16MAv2-puspr16_80r2as_2016_MAv2_v0_ext1-v1/160909_075812/0000/ --outName=QCD_HT700to1000    --isMC=True --xsec=6831  --saveTrig=True --min=100 --max=200 --file=QCD_HT_700to1000.txt

xrdcp QCD_HT700to1000_100.root root://cmseos.fnal.gov//store/user/mkrohn/HHHHTo4b/V23/QCD700/
