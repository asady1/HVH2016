...
python  slimTreeMaker_final.py root://cmsxrootd.fnal.gov//store/user/mkrohn/HHHHTo4b/V25/QCD1500.root --saveTrig="True" --ttbar="False" --data="False" --JECUp="False" --JECDown="False" --JERUp="False" --JERDown="False" --useReg="False" --outName=QCD_1500_tree_finally27.root
xrdcp QCD_1500_tree_finally27.root root://cmseos.fnal.gov//store/user/asady1/V25/
