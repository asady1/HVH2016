...
cp ../../getMiniTrees.py .
cp ../../QCD_HT_2000toInf_noExt.txt .
cp ../../trigger_objects.root .
cp ../../TMVARegression_BDTG.weights.xml .
cp ../../puppiCorr.root .

python getMiniTrees.py --pathIn=root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V24b/QCD_HT2000toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/VHBB_HEPPY_V24a_QCD_HT2000toInf_TuneCUETP8M1_13TeV-madgraphMLM-Py8__spr16MAv2-puspr16_80r2as_2016_MAv2_v0-v1/160909_070558/0000/ --outName=QCD_HT2000toInf_noExt    --isMC=True --xsec=25.24  --saveTrig=True --min=0 --max=46 --file=QCD_HT_2000toInf_noExt.txt

xrdcp QCD_HT2000toInf_noExt_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHHHTo4b/V23/QCD2000/
