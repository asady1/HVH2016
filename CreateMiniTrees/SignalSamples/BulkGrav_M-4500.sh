...
python getMiniTrees.py --pathIn=root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V24b/BulkGravTohhTohbbhbb_narrow_M-4500_13TeV-madgraph/VHBB_HEPPY_V24a_BulkGravTohhTohbbhbb_narrow_M-4500_13TeV-madgraph__spr16MAv2-puspr16_HLT_80r2as_v14-v1/161014_192431/0000/ --outName=BulkGrav_M-4500 --isMC=True --saveTrig=True --xsec=1.0 --min=0 --max=2 --file=BulkGrav_M-4500.txt

xrdcp BulkGrav_M-4500_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHHHTo4b/V23/BulkGrav_old/
