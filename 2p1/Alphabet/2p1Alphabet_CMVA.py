...
TTBar = DIST("TTBar", "/uscms_data/d3/asady1/HHcode/CMSSW_8_0_12/src/HH2016/BackgroundEstimate/CMVA/TT_SFs.root", "mynewTree", "(HLT2_HT800>0||HLT2_Quad_Triple>0||HLT2_Double_Triple>0)*2.71828^(0.0615-0.0005*ttHT/2)*"+str(Options.lumi)+"*831.76/75176620")
JetHT = DIST("JetHT", "/uscms_data/d3/asady1/HHcode/CMSSW_8_0_12/src/HH2016/BackgroundEstimate/CMVA/JetHT_pruned_cmva.root","mynewTree", "(HLT2_HT800>0)")
BTag = DIST("BTag","/uscms_data/d3/asady1/HHcode/CMSSW_8_0_12/src/HH2016/BackgroundEstimate/CMVA/BTag_pruned_cmva.root", "mynewTree", "((HLT2_HT800==0)&&((HLT2_Quad_Triple>0)||(HLT2_Double_Triple>0)))")
...
sigpath = "/uscms_data/d3/asady1/HHcode/CMSSW_8_0_12/src/HH2016/BackgroundEstimate/input/CMVA/"
...
#missing CMVA SF
		...
		Signal_mX_cmva_up = TH1F("Signal_mX_%s_"%(m)+Options.name+"_CMS_eff_cmvaUp", "", len(binBoundaries)-1, array('d',binBoundaries))
		Signal_mX_cmva_down = TH1F("Signal_mX_%s_"%(m)+Options.name+"_CMS_eff_cmvaDown", "", len(binBoundaries)-1, array('d',binBoundaries))
		...
		quickplot(sigpath+"tree_%s.root"%(m), "mynewTree", Signal_mX, variable, tag+ "&(HLT2_HT800>0||HLT2_Quad_Triple>0||HLT2_Double_Triple>0)", "puWeight*SF*cmvaSF2*cmvaSF2/1.")
		quickplot(sigpath+"tree_%s.root"%(m), "mynewTree", Signal_mX_btag_up, variable, tag +"&(HLT2_HT800>0||HLT2_Quad_Triple>0||HLT2_Double_Triple>0)", "puWeight*SFup*cmvaSF2*cmvaSF2/1.")
		quickplot(sigpath+"tree_%s.root"%(m), "mynewTree", Signal_mX_btag_down, variable, tag+ "&(HLT2_HT800>0||HLT2_Quad_Triple>0||HLT2_Double_Triple>0)", "puWeight*SFdown*cmvaSF2*cmvaSF2/1.")
		quickplot(sigpath+"tree_%s.root"%(m), "mynewTree", Signal_mX_cmva_up, variable, tag+ "&(HLT2_HT800>0||HLT2_Quad_Triple>0||HLT2_Double_Triple>0)", "puWeight*SF*cmvaSFup2*cmvaSFup2/1.")
		quickplot(sigpath+"tree_%s.root"%(m), "mynewTree", Signal_mX_cmva_down, variable, tag+ "&(HLT2_HT800>0||HLT2_Quad_Triple>0||HLT2_Double_Triple>0)", "puWeight*SF*cmvaSFdown2*cmvaSFdown2/1.")
		quickplot(sigpath+"tree_%s.root"%(m), "mynewTree", Signal_mX_pu_up, variable, tag + "&(HLT2_HT800>0||HLT2_Quad_Triple>0||HLT2_Double_Triple>0)", "puWeightUp*SF*cmvaSF2*cmvaSF2/1.")
		quickplot(sigpath+"tree_%s.root"%(m), "mynewTree", Signal_mX_pu_down, variable, tag + "&(HLT2_HT800>0||HLT2_Quad_Triple>0||HLT2_Double_Triple>0)", "puWeightDown*SF*cmvaSF2*cmvaSF2/1.")
...
#		norm = GetNom(sigpath+"tree_%s.root"%(m))
		...
		Signal_mX_cmva_up.Scale(0.01*Options.lumi/norm)
		Signal_mX_cmva_down.Scale(0.01*Options.lumi/norm)
		...
		Signal_mX_cmva_up.Write()
		Signal_mX_cmva_down.Write()
		data_obs.Write()
		vh.Write()
		output_file.Write()
		output_file.Close()
