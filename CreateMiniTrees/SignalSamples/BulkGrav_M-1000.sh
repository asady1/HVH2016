...
python getMiniTrees.py --pathIn=root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V24b/BulkGravTohhTohbbhbb_narrow_M-1000_13TeV-madgraph/VHBB_HEPPY_V24a_BulkGravTohhTohbbhbb_narrow_M-1000_13TeV-madgraph__spr16MAv2-puspr16_HLT_80r2as_v14-v3/161014_191835/0000/ --outName=BulkGrav_M-1000 --isMC=True --saveTrig=True --xsec=1.0 --min=0 --max=3 --file=BulkGrav_M-1000.txt --syst=None

xrdcp BulkGrav_M-1000_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHHHTo4b/V23/BulkGrav_old/
