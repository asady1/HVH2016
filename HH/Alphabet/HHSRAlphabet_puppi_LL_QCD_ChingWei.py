...
Hbb2 = Alphabetizer(Options.name, DistsWeWantToEstimate, [])
Hbb2.SetRegions(var_array, TightPre)
...
plotforplotting.GetYaxis().SetRangeUser(0.15,0.35)
...
#        N.GetYaxis().SetRangeUser(30.,1000.)
else:
...
if Options.workspace == "alphabet":
	...
	for m in mass:
		...
		print "Signal_mX_trig_up.GetSumOfWeights()"
		print Signal_mX_trig_up.GetSumOfWeights()
		print "Signal_mX_trig_down.GetSumOfWeights()"
		print Signal_mX_trig_down.GetSumOfWeights()
		...
		btagUp_integral = Signal_mX_btag_up.Integral()
		btagDown_integral = Signal_mX_btag_down.Integral()
