...
python  slimTreeMaker_final.py root://cmsxrootd.fnal.gov//store/user/asady1/V25/QCD_HT300to500.root --saveTrig="True" --ttbar="False" --data="False" --JECUp="False" --JECDown="False" --JERUp="False" --JERDown="False" --useReg="False"  --outName=QCD_300_tree_finally27.root
xrdcp QCD_300_tree_finally27.root root://cmseos.fnal.gov//store/user/asady1/V25/
