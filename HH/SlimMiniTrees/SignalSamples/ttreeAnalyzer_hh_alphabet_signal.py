...
#	    continue
	...
	if math.isnan(dijetmass_pruned_corr[0]):
           trigWeight[0] = 1
           trigWeightUp[0] = 1
           trigWeightDown[0] = 1
        else:
           trigWeight[0] = DataEf.GetBinContent(int(round(dijetmass_pruned_corr[0])))
           trigWeightUp[0] = trigWeight[0] + DataEf.GetBinError(int(round(dijetmass_pruned_corr[0])))
           trigWeightDown[0] = trigWeight[0] - DataEf.GetBinError(int(round(dijetmass_pruned_corr[0])))
