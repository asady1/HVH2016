#!/bin/bash
for i in 750 800 1000 1200 1400 1600
do
	echo "mass point $i"
	mkdir Limits/sig$i
	combineCards.py outputs/datacards/HH4b2p1_mX_$i\_Rad_both_dEta0_13TeV.txt outputs/datacards/HH4b2p1_mX_$i\_Rad_both_dEta1_13TeV.txt > outputs/datacards/HH4b2p1_mX_$i\_test_13TeV.txt
