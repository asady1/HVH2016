...
class LinearFit:
	...
	X = var + "-" + str(center)
	self.ConvFact = "({0:4.18f} + (({2})*{1:4.18f}))".format(self.ErrUp.GetParameter(0),self.ErrUp.GetParameter(1),X)
	self.ConvFactUp = "({0:4.18f} + (({5})*{1:4.18f}) + (({5})*({5})*{3:4.18f}*{3:4.18f}+(({5})*2*{4:4.18f})+({2:4.18f}*{2:4.18f}))^0.5)".format(self.ErrUp.GetParameter(0),self.ErrUp.GetParameter(1),self.ErrUp.GetParameter(2),self.ErrUp.GetParameter(3),self.ErrUp.GetParameter(4),X)
	self.ConvFactDn = "({0:4.18f} + (({5})*{1:4.18f}) - (({5})*({5})*{3:4.18f}*{3:4.18f}+(({5})*2*{4:4.18f})+({2:4.18f}*{2:4.18f}))^0.5)".format(self.ErrUp.GetParameter(0),self.ErrUp.GetParameter(1),self.ErrUp.GetParameter(2),self.ErrUp.GetParameter(3),self.ErrUp.GetParameter(4),X)
