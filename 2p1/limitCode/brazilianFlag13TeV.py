...
#        radmasses.append(float(f.replace("CMS_jj_","").split("_")[0])/1000.)
        radmasses = [0.75,0.8,0.9,1.0,1.2,1.6,2.0,2.2,2.5,2.75,3.0]#,3.5,4.,4.5]
    print radmasses
    ...
    mg.GetXaxis().SetRangeUser(0.75,2.0)
...
#        if exp(glogtheory.Eval(mass/1000.))<grobs.Eval(mass/1000.) and crossing<=0:
    ...
    if withAcceptance:
        ...
        c1.SaveAs("brazilianFlag_2p1BG1p1_%s_13TeV.root" %label)
        c1.SaveAs("brazilianFlag_2p1BG1p1_%s_13TeV.pdf" %label)
        c1.SaveAs("brazilianFlag_2p1BG1p1_%s_13TeV_edit.C" %label)
...
if __name__ == '__main__':
  ...
  for chan in channels:
    print "chan =",chan
    masses =[750,800,900,1000,1200,1600,2000,2200,2500,2750,3000]
