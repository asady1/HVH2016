...
python  slimTreeMaker_final.py root://cmsxrootd.fnal.gov//store/user/mkrohn/HHHHTo4b/V25/QCD1000.root --saveTrig="True" --ttbar="False" --data="False" --JECUp="False" --JECDown="False" --JERUp="False" --JERDown="False" --useReg="False" --outName=QCD_1000_tree_finally27.root
xrdcp QCD_1000_tree_finally27.root root://cmseos.fnal.gov//store/user/asady1/V25/

#python  slimTreeMaker_csv.py root://cmsxrootd.fnal.gov//store/user/mkrohn/HHHHTo4b/V25/QCD1500.root --saveTrig="True" --ttbar="False" --data="False" --outName=QCD_1500_tree_mb.root
#xrdcp QCD_1500_tree_dcsv.root root://cmseos.fnal.gov//store/user/asady1/V25/

#python  slimTreeMaker_csv.py root://cmsxrootd.fnal.gov//store/user/mkrohn/HHHHTo4b/V25/QCD2000.root --saveTrig="True" --ttbar="False" --data="False" --outName=QCD_2000_tree_dcsv.root
#xrdcp QCD_2000_tree_dcsv.root root://cmseos.fnal.gov//store/user/asady1/V25/

#python  slimTreeMaker_csv.py root://cmsxrootd.fnal.gov//store/user/asady1/V25/QCD_HT300to500.root --saveTrig="True" --ttbar="False" --data="False" --outName=QCD_300_tree_dcsv.root
#xrdcp QCD_300_tree_dcsv.root root://cmseos.fnal.gov//store/user/asady1/V25/

#python  slimTreeMaker_csv.py root://cmsxrootd.fnal.gov//store/user/mkrohn/HHHHTo4b/V25/QCD500.root --saveTrig="True" --ttbar="False" --data="False" --outName=QCD_500_tree_dcsv.root
#xrdcp QCD_500_tree_dcsv.root root://cmseos.fnal.gov//store/user/asady1/V25/
