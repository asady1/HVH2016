...
if Options.workspace == "alphabet":
	...
	for m in mass:
		...
		text_file.write("imax    2     number of categories\n")
		text_file.write("jmax   3     number of samples minus one\n")
		...
		text_file.write("-------------------------------------------------------------------------------\n")
		text_file.write("bin                                            vh4b_pass			vh4b_fail\n")
		text_file.write("observation                                    -1.0					-1.0\n")
		text_file.write("-------------------------------------------------------------------------------\n")
		text_file.write("bin                                             vh4b_pass            vh4b_pass	vh4b_fail	vh4b_fail\n")
		text_file.write("process                                         Signal_mX_%s_"%(m)+Options.name+"  "+Options.name+"EST	Signal_mX_antitag_%s_"%(m)+Options.name+"  "+Options.name+"EST_antitag\n")
		text_file.write("process                                          -1      0	1	2\n")
		text_file.write("rate                                            %f 	1.0000	%f	1.0000\n"%(signal_integral,signal_integral_anti))
		text_file.write("-------------------------------------------------------------------------------\n")
