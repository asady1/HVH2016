...
python  slimTreeMaker_final.py root://cmsxrootd.fnal.gov//store/user/mkrohn/HHHHTo4b/V25/QCD700.root --saveTrig="True" --ttbar="False" --data="False" --JECUp="False" --JECDown="False" --JERUp="False" --JERDown="False" --useReg="False" --outName=QCD_700_tree_finally27.root
xrdcp QCD_700_tree_finally27.root root://cmseos.fnal.gov//store/user/asady1/V25/
