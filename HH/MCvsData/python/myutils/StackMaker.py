...
class StackMaker:
	...
	#print self.nBins
        ...
        self.options = {'var': self.name,'name':'','xAxis': self.xAxis, 'nBins': self.nBins, 'xMin': self.xMin, 'xMax': self.xMax,'pdfName': '%s_%s_%s_Log%s.pdf'%(region,var,self.mass,self.log),'cut':cut,'mass': self.mass, 'data': data, 'blind': self.blind}
