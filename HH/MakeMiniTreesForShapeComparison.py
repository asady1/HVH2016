...
hJet1PMass = ROOT.TH1F("hJet1PMass", "Jet 1 Pruned Mass (GeV)", 30, 50, 300)
hJet2PMass = ROOT.TH1F("hJet2PMass", "Jet 2 Pruned Mass (GeV)", 30, 50, 300)
hJet1bbtag = ROOT.TH1F("hJet1bbtag", "Jet 1 Double b Discriminant (GeV)", 20, -1, 1)
hJet2bbtag = ROOT.TH1F("hJet2bbtag", "Jet 2 Double b Discriminant (GeV)", 20, -1, 1)
hJet1tau21 = ROOT.TH1F("hJet1tau21", "Jet 1 tau21", 20, 0, 1)
hJet2tau21 = ROOT.TH1F("hJet2tau21", "Jet 2 tau21", 20, 0, 1)
...
for i in range(0, nevent) :
    ...
    if treeMine.jet1pt > 200 and treeMine.jet2pt > 200 and abs(treeMine.jet1eta) < 2.4 and abs(treeMine.jet2eta) < 2.4 and abs(treeMine.jet1eta - treeMine.jet2eta) < 1.3 and treeMine.jet1tau21 < 0.6 and treeMine.jet2tau21 < 0.6 and treeMine.vtype == -1 and treeMine.json == 1 and treeMine.jet1ID == 1 and treeMine.jet2ID == 1 and treeMine.jet1pmass > 105 and treeMine.jet1pmass < 135 and treeMine.jet2pmass > 105 and treeMine.jet2pmass < 135 and treeMine.dijetmass_corr > 800 and treeMine.jet2bbtag > 0.6 and treeMine.jet1bbtag > 0.6:
	hJet1PMass.Fill(treeMine.jet1pmass)
	hJet2PMass.Fill(treeMine.jet2pmass)
	hJet1bbtag.Fill(treeMine.jet1bbtag)
	hJet2bbtag.Fill(treeMine.jet2bbtag)
	hJet1tau21.Fill(treeMine.jet1tau21)
	hJet2tau21.Fill(treeMine.jet2tau21)
