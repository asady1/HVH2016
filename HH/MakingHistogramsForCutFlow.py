...
bb4 = ROOT.TH1F("bb4", "After ht cut", 3, -0.5, 1.5)
bb5 = ROOT.TH1F("bb5", "After vtype cut", 3, -0.5, 1.5)
bb6 = ROOT.TH1F("bb6", "After jet eta and ID cuts", 3, -0.5, 1.5)
bb7 = ROOT.TH1F("bb7", "After jet pT cuts", 3, -0.5, 1.5)
bb8 = ROOT.TH1F("bb8", "After dijet mass cut", 3, -0.5, 1.5)
bb9 = ROOT.TH1F("bb9", "After jet pruned mass cuts", 3, -0.5, 1.5)
bb10 = ROOT.TH1F("bb10", "After tau21 cut", 3, -0.5, 1.5)
bb11 = ROOT.TH1F("bb11", "After bbtag cut", 3, -0.5, 1.5)
...
for i in range(0, nevent) :
    ...
    if ht[0] < 800:
        continue
    bb4.Fill(triggerpassbb[0])

    if vtype[0] > -1:
	continue
    bb5.Fill(triggerpassbb[0])

    if jet1eta[0] > 2.4 or jet2eta[0] > 2.4 or jet1ID[0] < 1 or jet2ID[0] < 1:
	continue
    bb6.Fill(triggerpassbb[0])    

    if jet1pt[0] < 200 or jet2pt[0] < 200:
	continue
    bb7.Fill(triggerpassbb[0])

    if dijetmass_corr[0] < 800:
	continue
    bb8.Fill(triggerpassbb[0])

    if jet1pmass[0] < 105 or jet1pmass[0] > 135 or jet2pmass[0] < 105 or jet2pmass[0] > 135:
	continue
    bb9.Fill(triggerpassbb[0])

    if jet1tau21[0] > 0.6 or jet2tau21[0] > 0.6:
	continue
    bb10.Fill(triggerpassbb[0])

    if jet1bbtag[0] < 0.6 or jet2bbtag[0] < 0.6:
	continue
    bb11.Fill(triggerpassbb[0])
