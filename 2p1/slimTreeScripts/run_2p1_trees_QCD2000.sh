...
python  slimTreeMaker_final.py root://cmsxrootd.fnal.gov//store/user/mkrohn/HHHHTo4b/V25/QCD2000.root --saveTrig="True" --ttbar="False" --data="False" --JECUp="False" --JECDown="False" --JERUp="False" --JERDown="False" --useReg="False" --outName=QCD_2000_tree_finally27.root
xrdcp QCD_2000_tree_finally27.root root://cmseos.fnal.gov//store/user/asady1/V25/
