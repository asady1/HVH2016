...
preselection    =       "&(vtype==-1||vtype==4)&jetVpt>200&json==1&jetHpt>200&abs(jetVeta-jetHeta)<1.3&(jetVtau21DDT<0.45)&(jetHtau21DDT<0.8)&dijetmass_corr>800&jetVID==1&jetHID==1&abs(jetVeta)<2.4&abs(jetHeta)<2.4&(HLT_PFHT800_v==1||HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1||HLT_AK8PFJet360_V==1||HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v==1)"
...
TightAT                 =       TightPre + "&jetH_puppi_msoftdrop_TheaCorr>105&jetH_puppi_msoftdrop_TheaCorr<135&(jetHbbtag<"+str(Options.tightcut)+")"
#TightAT 		=	TightPre + "&jet1pmass>105&jet1pmass<135&(jet1bbtag<"+str(Options.tightcut)+")"
TightT          =       TightPre + "&jetH_puppi_msoftdrop_TheaCorr>105&jetH_puppi_msoftdrop_TheaCorr<135&(jetHbbtag>"+str(Options.tightcut)+")"
...
TightT2         = "jetV_puppi_msoftdrop_raw_TheaCorr > 65 & jetV_puppi_msoftdrop_raw_TheaCorr< 105  &  jetHbbtag < 0.8 &(vtype==-1||vtype==4)&jetVpt>200&json==1&jetHpt>200&abs(jetHeta-jetVeta)<1.3&(jetHtau21DDT<0.8)&(jetVtau21DDT<0.45)&dijetmass_corr>800&jetVID==1&jetHID==1&abs(jetHeta)<2.4&abs(jetVeta)<2.4&jetH_puppi_msoftdrop_raw_TheaCorr>105&jetH_puppi_msoftdrop_raw_TheaCorr<135&(jetHbbtag>0.3)&(HLT_PFHT800_v==1||HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1||HLT_AK8PFJet360_V==1||HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v==1)"
...
if Options.workspace == "alphabet":
	...
	mass=[800,1000,1400,1600,1800,2000,2500, 3000,3500,4000,4500]
	for m in mass:
		print str(m)
		SF_tau21 = 0.963
		UD = ['Up','Down']
		...
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1||HLT_AK8PFJet360_V==1||HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v==1)", "puWeights*SF/1.")
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX_btag_up, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1||HLT_AK8PFJet360_V==1||HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v==1)", "puWeights*SFup/1.")
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX_btag_down, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1||HLT_AK8PFJet360_V==1||HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v==1)", "puWeights*SFdown/1.")
		...
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX_pu_up, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1||HLT_AK8PFJet360_V==1||HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v==1)", "puWeightsUp*SF/1.")
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX_pu_down, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1||HLT_AK8PFJet360_V==1||HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v==1)", "puWeightsDown*SF/1.")
