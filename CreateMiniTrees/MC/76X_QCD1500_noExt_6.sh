...
python getMiniTrees.py --pathIn=root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V24b/QCD_HT1500to2000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/VHBB_HEPPY_V24a_QCD_HT1500to2000_TuneCUETP8M1_13TeV-madgraphMLM-Py8__spr16MAv2-puspr16_80r2as_2016_MAv2_v0-v3/161122_153524/0000/ --outName=QCD_HT1500to2000_noExt    --isMC=True --xsec=119.9  --saveTrig=True --min=60 --max=70 --file=QCD_HT_1500to2000_noExt.txt

xrdcp QCD_HT1500to2000_noExt_60.root root://cmseos.fnal.gov//store/user/mkrohn/HHHHTo4b/V23/QCD1500/
