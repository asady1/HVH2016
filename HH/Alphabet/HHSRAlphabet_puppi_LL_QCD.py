...
parser.add_option('--B', '--binsize', metavar='Bin', type='string', dest='bin', default="8")
...
TightAT                 =       TightPre + "&jet1_puppi_msoftdrop_raw*jet1_puppi_TheaCorr>105&jet1_puppi_msoftdrop_raw*jet1_puppi_TheaCorr<135&(jet1bbtag<"+str(Options.tightcut)+")"
#TightAT 		=	TightPre + "&jet1pmass>105&jet1pmass<135&(jet1bbtag<"+str(Options.tightcut)+")"
TightT          =       TightPre + "&jet1_puppi_msoftdrop_raw*jet1_puppi_TheaCorr>105&jet1_puppi_msoftdrop_raw*jet1_puppi_TheaCorr<135&(jet1bbtag>"+str(Options.tightcut)+")"
