...
mynewTree.Branch('jetVtau21puppi', jetVtau21puppi, 'jetVtau21puppi/F')
...
for i in range(num1, num2):
	...
	if treeMine.jet1eta > 2.4 or treeMine.jet2eta > 2.4:
	    continue

	if abs(treeMine.jet1eta - treeMine.jet2eta) > 1.3:
	    continue

	if treeMine.jet1ID==0 or treeMine.jet2ID==0:
	    continue

	if treeMine.HLT_PFHT800_v==0 and treeMine.HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20_v==0 and treeMine.HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==0 and treeMine.HLT_AK8PFJet360_V==0 and treeMine.HLT_AK8PFHT650_TrimR0p1PT0p03Mass50_v==0:
	    continue

	if treeMine.jet2pt < 200 or treeMine.jet1pt < 200:
	    continue

	if treeMine.vtype!=-1 and treeMine.vtype!=4:
	    continue

	if treeMine.dijetmass < 800:
	    continue
	   ...
	   whichJetIsV = 1
        ...
        if whichJetIsV == 1: 
           ...
           if treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr*treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr/treeMine.jet1_puppi_pt > 0:
             jetVtau21DDT[0] = treeMine.jet1_puppi_tau21+0.063*math.log(treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr*treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr/treeMine.jet1_puppi_pt)
           else:
   	   ...
   	   jetV_puppi_msoftdrop_TheaCorr[0] = treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr
           ...
           if treeMine.jet2_puppi_msoftdrop*treeMine.jet2_puppi_TheaCorr*treeMine.jet2_puppi_msoftdrop*treeMine.jet2_puppi_TheaCorr/treeMine.jet2_puppi_pt > 0:
             jetHtau21DDT[0] = treeMine.jet2_puppi_tau21+0.063*math.log(treeMine.jet2_puppi_msoftdrop*treeMine.jet2_puppi_TheaCorr*treeMine.jet2_puppi_msoftdrop*treeMine.jet2_puppi_TheaCorr/treeMine.jet2_puppi_pt)
           else:
	   ...
	   jetHbbtag[0] = treeMine.jet2bbtag
        ...
        if whichJetIsV == 2: 
           ...
           if treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr*treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr/treeMine.jet1_puppi_pt > 0:
             jetHtau21DDT[0] = treeMine.jet1_puppi_tau21+0.063*math.log(treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr*treeMine.jet1_puppi_msoftdrop*treeMine.jet1_puppi_TheaCorr/treeMine.jet1_puppi_pt)
           else:
             jetHtau21DDT[0] = -99999
           ...
           if treeMine.jet2_puppi_msoftdrop*treeMine.jet2_puppi_TheaCorr*treeMine.jet2_puppi_msoftdrop*treeMine.jet2_puppi_TheaCorr/treeMine.jet2_puppi_pt > 0:
             jetVtau21DDT[0] = treeMine.jet2_puppi_tau21+0.063*math.log(treeMine.jet2_puppi_msoftdrop*treeMine.jet2_puppi_TheaCorr*treeMine.jet2_puppi_msoftdrop*treeMine.jet2_puppi_TheaCorr/treeMine.jet2_puppi_pt)
           else:
             jetVtau21DDT[0] = -99999
...
#	if jetV_puppi_msoftdrop_TheaCorr[0] < 65 or jetV_puppi_msoftdrop_TheaCorr[0] > 105:
#	    continue

#	if jetH_puppi_msoftdrop_TheaCorr[0] < 50 or jetH_puppi_msoftdrop_TheaCorr[0] > 200:
#	    continue

#	if jetHtau21DDT[0] > 0.8:
#	    continue

#	if jetVtau21DDT[0] > 0.8:
#	    continue
