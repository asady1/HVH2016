...
preselection    =       "&(vtype==-1||vtype==4)&jet2_puppi_pt>200&json==1&jet1_puppi_pt>200&abs(jet1_puppi_eta-jet2_puppi_eta)<1.3&jet1_puppi_tau21<0.6&jet2_puppi_tau21<0.6&dijetmass_puppi>800&jet2ID==1&jet1ID==1&abs(jet1_puppi_eta)<2.4&abs(jet2_puppi_eta)<2.4&HLT_PFHT800_v==1"
...
if Options.workspace == "alphabet":
	...
	for m in mass:
		...
		quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX, variable2, TightT2+"&HLT_PFHT800_v>0", "puWeights*SF/1.")
		quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_btag_up, variable2, TightT2+"&HLT_PFHT800_v>0", "puWeights*SFup/1.")
		quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_btag_down, variable2, TightT2+"&HLT_PFHT800_v>0", "puWeights*SFdown/1.")
		...
		quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_pu_up, variable2, TightT2+"&HLT_PFHT800_v>0", "puWeightsUp*SF/1.")
		quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_pu_down, variable2, TightT2+"&HLT_PFHT800_v>0", "puWeightsDown*SF/1.")
