...
CMS_lumi.lumi_13TeV = "9.3 fb^{-1} (2016)"
...
#        radmasses.append(float(f.replace("CMS_jj_","").split("_")[0])/1000.)
        radmasses = [0.8,0.9,1.0,1.2,1.4,1.6,1.8,2.0,2.5,3.]#,3.5,4.,4.5]
    print radmasses
...
if __name__ == '__main__':
  ...
  for chan in channels:
    print "chan =",chan
    masses =[800,900,1000,1200,1400,1600,1800,2000,2500,3000]
    ...
    Plot(HPplots,chan+"_HH4b", unblind)
