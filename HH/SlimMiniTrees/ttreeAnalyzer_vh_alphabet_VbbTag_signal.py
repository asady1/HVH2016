...
jetVtau21puppi = array('f', [-100.0])
jetHtau21puppi = array('f', [-100.0])
...
json = array('f', [-100.0])
jetHbbtagSFLoose = array('f', [-100.0])
jetHbbtagSFLooseup = array('f', [-100.0])
jetHbbtagSFLoosedown = array('f', [-100.0])
jetHbbtagSFTight = array('f', [-100.0])
jetHbbtagSFTightup = array('f', [-100.0])
jetHbbtagSFTightdown = array('f', [-100.0])
...
mynewTree.Branch('jetVtau21puppi', jetVtau21puppi, 'jetVtau21/F')
mynewTree.Branch('jetHtau21puppi', jetHtau21puppi, 'jetHtau21puppi/F')
...
mynewTree.Branch('jetHbbtagSFLoose', jetHbbtagSFLoose, 'jetHbbtagSFLoose/F')
mynewTree.Branch('jetHbbtagSFLooseup', jetHbbtagSFLooseup, 'jetHbbtagSFLooseup/F')
mynewTree.Branch('jetHbbtagSFLoosedown', jetHbbtagSFLoosedown, 'jetHbbtagSFLoosedown/F')
mynewTree.Branch('jetHbbtagSFTight', jetHbbtagSFTight, 'jetHbbtagSFTight/F')
mynewTree.Branch('jetHbbtagSFTightup', jetHbbtagSFTightup, 'jetHbbtagSFTightup/F')
mynewTree.Branch('jetHbbtagSFTightdown', jetHbbtagSFTightdown, 'jetHbbtagSFTightdown/F')
	...
	jet1_puppi_msoftdrop_raw[0] = treeMine.jet1_puppi_msoftdrop_raw
	   ...
	   whichJetIsV = 1
        ...
        if whichJetIsV == 1: 
           ...
           jetVtau21puppi[0] = treeMine.jet1_puppi_tau21

	   if treeMine.jet1_puppi_msoftdrop_raw*treeMine.jet1_puppi_TheaCorr*treeMine.jet1_puppi_msoftdrop_raw*treeMine.jet1_puppi_TheaCorr/treeMine.jet1_puppi_pt > 0:
             jetVtau21DDT[0] = treeMine.jet1_puppi_tau21+0.063*math.log(treeMine.jet1_puppi_msoftdrop_raw*treeMine.jet1_puppi_TheaCorr*treeMine.jet1_puppi_msoftdrop_raw*treeMine.jet1_puppi_TheaCorr/treeMine.jet1_puppi_pt)
	   else:
	     jetVtau21DDT[0] = -99999
   	   ...
   	   jetV_puppi_msoftdrop_TheaCorr[0] = jet1_puppi_msoftdrop[0]*jet1_puppi_TheaCorr[0]
           ...
           jetHtau21puppi[0] = treeMine.jet2_puppi_tau21

           if treeMine.jet2_puppi_msoftdrop_raw*treeMine.jet2_puppi_TheaCorr*treeMine.jet2_puppi_msoftdrop_raw*treeMine.jet2_puppi_TheaCorr/treeMine.jet2_puppi_pt > 0:
             jetHtau21DDT[0] = treeMine.jet2_puppi_tau21+0.063*math.log(treeMine.jet2_puppi_msoftdrop_raw*treeMine.jet2_puppi_TheaCorr*treeMine.jet2_puppi_msoftdrop_raw*treeMine.jet2_puppi_TheaCorr/treeMine.jet2_puppi_pt)
	   else:
	   ...
	   jetHbbtag[0] = treeMine.jet2bbtag
           ...
           jetHbbtagSFLoose[0] = treeMine.bbtag2SFLoose
           jetHbbtagSFLooseup[0] = treeMine.bbtag2SFLooseUp
           jetHbbtagSFLoosedown[0] = treeMine.bbtag2SFLooseDown

           jetHbbtagSFTight[0] = treeMine.bbtag2SFTight
           jetHbbtagSFTightup[0] = treeMine.bbtag2SFTightUp
           jetHbbtagSFTightdown[0] = treeMine.bbtag2SFTightDown

        if whichJetIsV == 2: 
           jetHpt[0] = treeMine.jet1pt
           jetHeta[0] = treeMine.jet1eta
           jetHtau21[0] = treeMine.jet1tau21
           jetHtau21puppi[0] = treeMine.jet1_puppi_tau21

           if treeMine.jet1_puppi_msoftdrop_raw*treeMine.jet1_puppi_TheaCorr*treeMine.jet1_puppi_msoftdrop_raw*treeMine.jet1_puppi_TheaCorr/treeMine.jet1_puppi_pt > 0:
             jetHtau21DDT[0] = treeMine.jet1_puppi_tau21+0.063*math.log(treeMine.jet1_puppi_msoftdrop_raw*treeMine.jet1_puppi_TheaCorr*treeMine.jet1_puppi_msoftdrop_raw*treeMine.jet1_puppi_TheaCorr/treeMine.jet1_puppi_pt)
	   else:
	     jetHtau21DDT[0] = -99999
           ...
           jetVtau21puppi[0] = treeMine.jet2_puppi_tau21

	   if treeMine.jet2_puppi_msoftdrop_raw*treeMine.jet2_puppi_TheaCorr*treeMine.jet2_puppi_msoftdrop_raw*treeMine.jet2_puppi_TheaCorr/treeMine.jet2_puppi_pt > 0:
             jetVtau21DDT[0] = treeMine.jet2_puppi_tau21+0.063*math.log(treeMine.jet2_puppi_msoftdrop_raw*treeMine.jet2_puppi_TheaCorr*treeMine.jet2_puppi_msoftdrop_raw*treeMine.jet2_puppi_TheaCorr/treeMine.jet2_puppi_pt)
	   else:
	     jetVtau21DDT[0] = -99999
           ...
           jetHbbtagSFLoose[0] = treeMine.bbtag1SFLoose
           jetHbbtagSFLooseup[0] = treeMine.bbtag1SFLooseUp
           jetHbbtagSFLoosedown[0] = treeMine.bbtag1SFLooseDown

           jetHbbtagSFTight[0] = treeMine.bbtag1SFTight
           jetHbbtagSFTightup[0] = treeMine.bbtag1SFTightUp
           jetHbbtagSFTightdown[0] = treeMine.bbtag1SFTightDown
        ...
        jet1_TL = ROOT.TLorentzVector()
        jet1_TL.SetPtEtaPhiM(treeMine.jet1pt, treeMine.jet1eta, treeMine.jet1phi, treeMine.jet1mass)

        jet2_TL = ROOT.TLorentzVector()
        jet2_TL.SetPtEtaPhiM(treeMine.jet2pt, treeMine.jet2eta, treeMine.jet2phi, treeMine.jet2mass)

        dijetmass[0] = (jet1_TL + jet2_TL).M()	
