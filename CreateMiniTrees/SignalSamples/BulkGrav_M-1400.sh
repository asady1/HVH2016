...
python getMiniTrees.py --pathIn=root://cmseos.fnal.gov//store/user/lpchbb/HeppyNtuples/V24b/BulkGravTohhTohbbhbb_narrow_M-1400_13TeV-madgraph/VHBB_HEPPY_V24a_BulkGravTohhTohbbhbb_narrow_M-1400_13TeV-madgraph__spr16MAv2-puspr16_HLT_80r2as_v14-v1/161014_191953/0000/ --outName=BulkGrav_M-1400 --isMC=True --xsec=1.0 --saveTrig=True --min=0 --max=3 --file=BulkGrav_M-1400.txt

xrdcp BulkGrav_M-1400_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHHHTo4b/V23/BulkGrav_old/
