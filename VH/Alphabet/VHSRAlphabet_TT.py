...
preselection    =       "&(vtype==-1||vtype==4)&jetVpt>200&json==1&jetHpt>200&abs(jetVeta-jetHeta)<1.3&jetVtau21<0.6&jetHtau21<0.6&dijetmass_puppi>800&jetVID==1&jetHID==1&abs(jetVeta)<2.4&abs(jetHeta)<2.4&(HLT_PFHT800_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1)"
...
DATA = DIST("DATA", "/uscms_data/d3/mkrohn/CMSSW_8_0_12/src/HH2016/SlimMiniTrees/JetHT_VH_addTrigger.root","mynewTree","1.")
...
if Options.workspace == "alphabet":
	...
	mass=[800,1000,1600,1800,2000,2500, 3000,3500,4000,4500]
	for m in mass:
		print str(m)
		SF_tau21 =1.
		UD = ['Up','Down']
		...
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1)", "puWeights*SF/1.")
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX_btag_up, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1)", "puWeights*SFup/1.")
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX_btag_down, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1)", "puWeights*SFdown/1.")
		...
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX_pu_up, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1)", "puWeightsUp*SF/1.")
		quickplot(sigpath+"Wprime%s.root"%(m), "mynewTree", Signal_mX_pu_down, variable2, TightT2+"&(HLT_PFHT800_v==1||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5_v==1)", "puWeightsDown*SF/1.")
